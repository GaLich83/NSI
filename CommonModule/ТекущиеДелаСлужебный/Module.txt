...
//    * Подсказка     - Строка - текст подсказки.
//
Функция СписокТекущихДелПользователя(АдресХранилища, ПараметрыКлиентаНаСервере = Неопределено) Экспорт
	
	// Проброс параметров клиента в фоновое задание.
	Если ПараметрыКлиентаНаСервере <> Неопределено Тогда
